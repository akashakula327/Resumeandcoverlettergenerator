...
Ensure the response is structured, clear, and easy to display in a React app. 
        ...
        const options = {
            ...
            headers: {
                ...
                'X-goog-api-key': 'AIzaSyBnvXqIUr8it_Vnle7kvfPpVqhj6MWEnlQ'
            },
        ...
        try {
            ...
            if (!response.ok) {
                ...
                setGeminiResponse(`Error generating response: ${data.error?.message || response.statusText}`);
                return;
            }
            ...
            if (!generatedText) {
                ...
                setGeminiResponse('Error: Unexpected response from the AI service. Check the console for details.');
                return;
            }
            ...
            setGeminiResponse('Error generating response. See console for details.');
        } finally {
            setIsLoading(false);
        }
    }
                    ...
                    <div className="col-lg-8">
                        ...
                        <div className="card shadow-lg border-0 mb-5">
                            ...
                            <div className="card-body p-4">
                                <form>
                                    <div className="alert alert-info mb-4 app-note">
                                        <i className="bi bi-info-circle-fill me-2"></i>
                                        Enter the job details and current resume to get a tailored cover letter, resume suggestions, and ATS feedback.
                                    </div>
                                    <div className="row">
                                    ...
                                    <div className="d-grid">
                                        ...
                                        >
                                            ...
                                            {isLoading ? 'Generating AI Results...' : 'Generate AI-Powered Resume & Cover Letter'}
                                        </button>
                                    </div>
                                </form>
                            </div>
